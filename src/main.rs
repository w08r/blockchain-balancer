...
fn test( a: u128, b: u128, amount: u128, weight1: u128, weight2: u128)  {
    println!("{} * (1 - ({} / ({} + {})^({} / {})))",
             a, b, b, amount, weight1, weight2);
    println!("IEE754: {}", calc_n(a, b, amount, weight1, weight2));
    println!("MPFR: {}", calc(a, b, amount, weight1, weight2));
}
...
fn main() {
    ...
    test((1 << 100) | 1, 1 << 50 | 3, 2<<20 | 9, 3<<40|7, 5<<12|99);
}
...
// 1267650600228229401496703205377 * (1 - (1000 / (1000 + 23)^(45 / 56)))
// IEE754: 22953180340148131072116260864
// MPFR: 22953180340148171020920682723

// 1267650600228229401496703205377 * (1 - (1125899906842627 / (1125899906842627 + 2097161)^(3298534883335 / 20579)))
// IEE754: 327196840011588213748673806336
// MPFR: 327196839488591575425810699928
// 
